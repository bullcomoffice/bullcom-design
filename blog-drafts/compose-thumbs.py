...
TITLES = {
  "01": ["余白は削らないほうが", "いい理由"],
  "02": ["ブログには何を", "書けばいいのか"],
  "03": ["バックアップは何を", "どこまで取るか"],
  "04": ["あとからページを", "追加できる？"],
  "05": ["「こんな感じが好き」を", "どう伝えるか"],
  "06": ["サイトが表示されない", "とき確認する順番"],
  "07": ["アドレスバーの鍵マーク", "は何をしている？"],
  "08": ["ホームページ制作の費用は", "何で決まる？"],
  "09": ["「おしゃれ」より", "「伝わる」サイト"],
  "10": ["制作会社と連絡が", "取れなくなったとき"],
  "11": ["なぜNext.jsで", "作るのか"],
  "12": ["「丸投げ」でも", "大丈夫？"],
  "13": ["「写真がない」と", "言われたときに"],
  "14": ["「更新できないまま", "3年」を防ぐには"],
  "15": ["WordPressで", "作らない理由"],
  "16": ["依頼する前に", "決めておく3つのこと"],
  "17": ["ファーストビューの", "決め方"],
  "18": ["公開後に必要になる", "作業の一覧"],
  "19": ["静的サイトが", "改ざんされにくい理由"],
  "20": ["相見積もりで", "金額以外に見るところ"],
  "21": ["ロゴがないまま", "サイトを作ると"],
  "22": ["問い合わせが来ないとき", "見直す3つの場所"],
  "23": ["スマホで崩れる", "サイトとの違い"],
  "24": ["「誰に、何を伝えるか」", "を先に決める"],
  "25": ["色は3色までに", "まとめると失敗しない"],
  "26": ["ドメインとサーバー", "費用の中身"],
  "27": ["サイトが重い原因は", "画像にある"],
}
